...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 4203;
...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE     = 4*1024*1024; //size of block (bytes) after which reward for block calculated using block size
...
const uint64_t MAX_TRANSACTION_SIZE_LIMIT                          = 10000000000;
...
const size_t   MAX_BLOCK_SIZE_INITIAL                        =  4 * 1024 * 1024;
...
const char     GENESIS_COINBASE_TX_HEX[]                     = "010401ff00018080a8ec85afd1b10102245fd2320b5ab574c3d11facceafb8c0b88b8f6f2f419c0616c5ae458076407a21012d6d73b3d54866ac0523ad457f0648e6a2097e1fb17b98a8c0ab3b13e6e00550";
} // parameters

const char     CRYPTONOTE_NAME[]                             = "gladcoin";
...
const int      P2P_DEFAULT_PORT                              =  27111;
const int      RPC_DEFAULT_PORT                              =  27112;
...
const char* const SEED_NODES[] = { "31.186.25.62:27111", "31.186.25.63:27111" };
...
const std::initializer_list<CheckpointData> CHECKPOINTS = {
  // {79000,  "a5f85a82b12af07442e698d9c42d72ee1c0398da787636f12a449df3e54d4ae1"}
};
} // CryptoNote
